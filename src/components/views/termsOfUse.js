    ...
    return (
        <>
            <div className="terms-page">
                ...
                <p className='terms-of-use-text'>By accessing and using our website/service, you agree to comply with and be bound by the following terms and conditions. If you do not agree to these terms, please refrain from using our site.

Content Usage:

All content on this website is for informational purposes only.
You may not reproduce, distribute, or modify any part of the content without our prior written consent.
User Conduct:

Respect other users and refrain from engaging in any harmful or disruptive behavior.
Do not use our website for any unlawful or unauthorized purposes.
Privacy:
